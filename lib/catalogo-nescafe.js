...
function mesclar(catalogoAtual, produtosDoSite) {
  ...
  for (const doSite of produtosDoSite) {
    ...
    if (existente) {
      ...
      porChave.set(doSite.chave, {
        ...
        ativo: doSite.categoria !== 'Combos' && doSite.categoria !== 'Acessórios',
        url: doSite.url,
  ...
  return { catalogo: [...porChave.values()], novos, atualizados, sumiram, leituraParcial };
}
